...
const SvgComponent = () => (
  <div className="flex mx-1 items-center gap-2 text-xl font-semibold text-zinc-900">
      ...
      <defs>
        ...
        >
          ...
          <feBlend
            ...
            result="effect1_dropShadow_10417_307"
          />
          <feColorMatrix
            in="SourceAlpha"
            result="hardAlpha"
          ...
          <feBlend
            in2="effect1_dropShadow_10417_307"
            result="effect2_dropShadow_10417_307"
          />
          <feBlend
            in="SourceGraphic"
            in2="effect2_dropShadow_10417_307"
            result="shape"
          />
        </filter>
        <filter
        ...
        >
          ...
          <feComposite
            in2="SourceAlpha"
            operator="in"
            result="effect1_backgroundBlur_10417_307"
          />
          <feBlend
            in="SourceGraphic"
            in2="effect1_backgroundBlur_10417_307"
            result="shape"
          />
        </filter>
        <linearGradient
    ...
    <span className="font-semibold text-zinc-900 text-lg dark:text-zinc-100">
      {" "}
      Untitled UI
    </span>
  </div>
